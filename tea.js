...
var textParagraphs = [
    ...
    [3,"<p>Tea is grown all around Asia, especially in China and India. Tea grows all year long in most places, and is Tea harvested constantly as the leaves grow back. Tea is manually picked, then immediately taken to a factory. Tea goes through various processes depending on the type of tea, including drying, steaming, rolling, fermenting, and baking. Tea is then packaged and distributed.<p>", 156],
